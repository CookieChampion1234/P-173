...
label=Label(root,text="Job Assigning Application",font=("helvetica",20,"bold"),bg="teal")
label.place(relx=0.01,rely=0.09,anchor=W)

label_doctor=Label(root,text="Doctor : ",bg="teal")
label_doctor.place(relx=0.04,rely=0.25,anchor=CENTER)

label_IT=Label(root,text="IT professional: ",bg="teal")
label_IT.place(relx=0.06,rely=0.45,anchor=CENTER)

label_chemical_engi=Label(root,text="Chemical Engineer : ",bg="teal")
...
label_selected_doc=Label(root,font=("castellar",12,"bold"),fg="black")
label_selected_doc.place(relx=0.01,rely=0.32,anchor=W)

label_selected_IT=Label(root,font=("castellar",12,"bold"),fg="black")
label_selected_IT.place(relx=0.01,rely=0.52,anchor=W)

label_selected_chem_engi=Label(root,font=("castellar",12,"bold"),fg="black")
...
btn_doctor=Button(root,text="Show the hospital alotted",command=obj1.getDoctor,bg="yellow",relief=FLAT)
btn_doctor.place(relx=0.1,rely=0.18,anchor=CENTER)
btn_IT=Button(root,text="Show the It company alotted",command=obj2.getIT,bg="yellow",relief=FLAT)
btn_IT.place(relx=0.11,rely=0.38,anchor=CENTER)
btn_engi=Button(root,text="Show the chemical company alotted",command=obj3.getchemicalEngineer,bg="yellow",relief=FLAT)
